                        ...
                        <div class="card-body">
                            <div class="form-horizontal">
                                        ...
                                        <div class=" form-group row">
                                           ...
                                           <%-- <label class="control-label col-lg-2 ">TDS 5% </label>
                                            <div class="col-lg-4">
                                ...
                                <div class=" form-group row">
                                    ...
                                    <%--<label class="control-label col-lg-2 ">Fund Wallet 10% </label>
                                            <div class="col-lg-4">
                                                <asp:TextBox ID="txtFund" Text="" required="" ReadOnly="true" runat="server" CssClass="form-control"></asp:TextBox>
                                            </div>--%>
