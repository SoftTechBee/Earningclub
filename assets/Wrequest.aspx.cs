            ...
            if (TransPass == txtpassword.Text)
            {
                ...
                if (finalamount >= widamount && widamount >= 100)
                        ...
                        else
                        {
                            ...
                            lbwarning.Text = "Insufficient Amount (or) Minimum Withdrawal 100 ";
            ...
            decimal finalamount = Convert.ToDecimal(lbIncome.Text.Trim());
                ...
                if (finalamount >= reqAmt )
                {
                    ...
                    else
                    {
                        ...
                        sccess.Visible = false;
                        info.Visible = false;
                        lbwarning.Text = "Amount should be in multiple of 25";
                        warning.Visible = true;
                        txtAmt.Text = "";
                        txtAmt.Focus();
                    ...
                    else
                    {
                        ...
                        sccess.Visible = false;
                        info.Visible = false;
                        lbwarning.Text = "Amount should be greater than 125";
                        warning.Visible = true;
                        txtAmt.Text = "";
                        txtAmt.Focus();
                ...
                else
                {
                    ...
                    txtAmt.Text = "";
                    txtAmt.Focus();
                    Label1.Text = "Don't have enough Fund, “Please Enter a valid Amount ”";
                    warning.Visible = false;
                    btnaction.Focus();
                }
