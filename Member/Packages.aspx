            ...
            <div class="col-12 col-xl-4">
                <div class="card border-top border-4 border-primary">
                    <div class="card-body  p-4 bg-primary-subtle">
                        <div class="px-2 py-1 fw-medium bg-success bg-opacity-10 text-success text-uppercase w-50 text-center rounded">Earning Club</div>
                        <div class="my-4">
                        ...
                        <div class="d-grid">
                            <a href="SelfActive.aspx?id=<%=SessionData.Get<string>("ActiveUser") %>&Packid=<%#Eval("packid") %>" class="btn btn-sm btn-primary">Go Now?</a>
                        </div>
                    </div>
                </div>
            </div>
