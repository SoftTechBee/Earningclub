...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
          ...
          <div class="card card-primary">
              <div class="card-header with-border">
                  <div class="card-title">
                      <h3 class="text text-white">Change Password Here</h3>
                  </div>
              </div>
              <div class="card-body">
   ...
   <asp:Button ID="btnaction" runat="server" Text="Change"  OnClick="Button1_Click" CssClass="btn  btn-success btn-sm"/>
