<%@ Page Title="" Language="C#" MasterPageFile="~/Member/MasterPage.master" AutoEventWireup="true" CodeFile="LoanPendingUser.aspx.cs" Inherits="Admin_rptlevelIncome" %>
    ...
    <div class="form-horizontal">
        <div class="card-body">
            <div class=" form-group row">
                <div class=" col-lg-8">
                    <h4 class="card-title">Continue Loan User</h4>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="overflow: auto;">
                    <table id="example1" class="table table-bordered table-striped table-hover ">
                        ...
                        <td><%# Eval("EMIleft") %></td>
                                        ...
                                        <td>
                                            <a href="LoanEMIListUser.aspx?LoanID=<%#Eval("LoanID") %>&username=<%#Eval("UserName") %>" text="View" class="btn  btn-sm  btn-warning">View</a>
                                        </td>
                        <td><%# Eval("Loan") %></td>
                        <td><%# Eval("Amount") %></td>
                        <td><%# Eval("Interest") %></td>
