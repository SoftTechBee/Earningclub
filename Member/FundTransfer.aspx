...
<div  class="col-lg-12">
           <div class="card ">
              ...
              <h3> <asp:Label ID="txtbalance" runat="server" Text="0"></asp:Label></h3>
                     ...
                     <div class="mb-3 row">
                          ...
                          <asp:Textbox ID="txtAMount" OnTextChanged="txtAMount_TextChanged" AutoPostBack="true"   required="" runat="server"  CssClass="form-control" placeholder="Enter Transfer amount"></asp:Textbox>
                    </div>
                              </div>
   ...
   <asp:Button ID="btnaction" runat="server" Text="Transfer"  OnClick="butsubmit_Click" Width="200px" CssClass=" btn bg-success btn-flat btn-sm" OnClientClick="return confirmAction();" />
    ...
    <script>   
        function confirmAction() {
            let confirmAction = confirm("Are you Sure to Transfer Fund?");
