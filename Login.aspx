...
<head  runat="server">
    ...
    <title>Login-page ||Earning Club Earning</title>
    ...
    <div class="container-xxl" >
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner">
                <!-- Register -->
                <div class="card" style="background:#000000d9 !important">
                    <div class="card-body" style=" -webkit-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); -moz-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); box-shadow: 0px 0px 10px 5px #808080;">
                        <!-- Logo -->
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo ">

                                   <img src="Loginassets/img/logo/logo.png" style="width:110px  !important" />
                        ...
                        <div id="formAuthentication" class="mb-3" ">
                            ...
                            <div class="mb-3">
                                 <asp:Button runat="server" ID="btnLogin" CssClass="btn btn-info d-grid w-100" OnClick="btnLogin_Click"   Text="LogIn" />
                        ...
                        <p class="text-center">
                            <span>New on our Earning Club?</span>
                            <a href="Signup.aspx">
