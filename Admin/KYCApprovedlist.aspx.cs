...
public partial class Admin_KYCApprovedlist : System.Web.UI.Page
{
    ...
    private void loadinactivememberlist()
    {
        try
        {
            ...
            Sql += " ('Approved') AS status, (TblKYC.UserName) as username, (register.Name) as fullname ";
            Sql += " FROM TblKYC INNER JOIN  register ON TblKYC.UserName = register.Username ";
            Sql += " Where TblKYC.IsStatus  in (1) Order by TblKYC.AutoCode asc   ";
