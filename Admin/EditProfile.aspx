                  ...
                  <label class="control-label  col-lg-2">Select Marital</label>
                   ...
                   <asp:TextBox ID="txtDOA" runat="server"  Type="date"  class="form-control" placeholder="Enter  Aadhar Card Numbe"></asp:TextBox>              
                          ...
                          <div class="form-group row">
                               <div class="col-lg-8">
                             <center>
                 <asp:Button ID="bntsubmit" OnClick="bntsubmit_Click" OnClientClick="return Validate();" runat="server" Text="Save" Width="200px" CssClass=" btn bg-success btn-flat btn-lg"  />  
