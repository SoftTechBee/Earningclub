...
public partial class Admin_KYCRejectList : System.Web.UI.Page
{
    ...
    private void loadinactivememberlist()
    {
        try
        {
            ...
            Sql += " ('Reject') AS status, (TblKYC.UserName) as username, (register.Name) as fullname ";
            Sql += " FROM TblKYC INNER JOIN  register ON TblKYC.UserName = register.Username ";
            Sql += " Where TblKYC.IsStatus in (3) Order by TblKYC.AutoCode asc   ";
