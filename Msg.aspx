...
<head  runat="server">
    ...
    <title>Successfully Registration - Page |Earning Club</title>
...
<body id="top" data-theme-color="color-yellow"  style="background-image:url(Loginassets/img/logo/bg.jpg); background-size:cover; background-position:center">
 ...
 <!-- Content -->
                ...
                <div class="card" style="background:#000000d9 !important">
                   <div class="card-body" style=" -webkit-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); -moz-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); box-shadow: 0px 0px 10px 5px #000000;">
                        ...
                        <div id="formAuthentication" class="mb-3" ">
                            ...
                            <div class="mb-3">
                                 <asp:Button runat="server" ID="btnLogin" CssClass="btn btn-warning d-grid w-100" OnClick="btnLogin_Click"   Text="Login Now!" />
    ...
    <!-- / Content -->
<%-- <div class="buy-now">
        <a href="index.html" target="_blank" class="btn btn-danger btn-buy-now">Back ToEarning Club</a>
    </div>--%>
