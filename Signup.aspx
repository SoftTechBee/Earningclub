...
<head  runat="server">
    ...
    <title>Signup - Page | Earning Club</title>

    <meta name="description" content="Achieve new heights of success in life Start your own Business." />
    <meta name="keywords" content="Earning Club, business Earning Club, login ">
    <!-- Canonical SEO -->
                      ...
                      <%--<h4 class="mb-2">Welcome to UPTO!  </h4>--%>
                        ...
                        <div id="formAuthentication" class="mb-3" ">
                          ...
                          <div class="mb-1 form-password-toggle">
                            ...
                            <div class="mb-3">
                                 <asp:Button runat="server" ID="btnRegister" OnClientClick="return validatepassword();" OnClick="btnRegister_Click"  CssClass="btn btn-info d-grid w-100"  Text="Register" />
                        ...
                        <p class="text-center">
                            <span>Already on our Earning Club?</span>
                            <a href="login.aspx">
